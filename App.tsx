...
import { translations, questions, typeData } from '@/lib/quizData'
...
function App() {
  ...
  const ResultScreen = () => {
    const type = result ? typeData[result as keyof typeof typeData] : null
        ...
        <div className="result-content">
          ...
          <Card className="compatibility-card">
            ...
            <div className="compatibility-types">
              {type.compatibility.map((compatType: string) => {
                const compatData = typeData[compatType as keyof typeof typeData]
                return (
                  <div key={compatType} className="compat-type">
                    <span className="compat-code">{compatType}</span>
                    <span className="compat-name">{compatData.name[language]}</span>
                  </div>
                )
              })}
            </div>
